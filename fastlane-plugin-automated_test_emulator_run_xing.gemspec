...
Gem::Specification.new do |spec|
  ...
  spec.author        = %q{Daniel Hartwich}
  spec.email         = %q{hartwich.daniel@gmail.com}
  ...
  spec.homepage      = "https://github.com/dhartwich1991/fastlane-plugin-automated-test-emulator-run"
  spec.license       = "MIT"
